                    ...
                    <div className="max-w-4xl mx-auto">
                                                ...
                                                <div>
                                                    ...
                                                    <div
                                                        ...
                                                        <p className="font-medium">
                                                            H.B.Sc. in Applied Statistics, Minor in Computer Science and
                                                            Mathematics
                                                        </p>
                                                        <div className="text-muted-foreground">
                                                    ...
                                                    <ul className="list-disc list-inside text-muted-foreground space-y-1">
                                                        <li>
                                                            <span
                                                                className="font-medium text-foreground">Awards:</span> Lester
                                                            B. Pearson International Scholarship (Full-Ride
                                                            Scholarship),
                        ...
                        <section className="mb-12">
                                        ...
                                        <Card>
                                            <CardContent className="pt-6">
                                                <div className="flex flex-col">
                                                    <h3 className="text-xl font-bold">The Data Science Course: Complete
                                                        Data Science Bootcamp 2024</h3>
                                                    <p className="text-muted-foreground mb-2">Udemy, Jun 2024</p>
                                                    <Link href="https://ude.my/UC-27613d14-da18-446f-858e-d905f8cfc4a8"
                                ...
                                <FadeIn delay={0.2} direction="up">
                                    <HoverScale>
                                        <Card>
                                            <CardContent className="pt-6">
                                                <div className="flex flex-col">
                                                    <h3 className="text-xl font-bold">Applied Data Science with R -
                                                        Specialization</h3>
                                ...
                                <FadeIn delay={0.3} direction="up">
                                    <HoverScale>
                                        <Card>
                                            <CardContent className="pt-6">
                                                <div className="flex flex-col">
                                                    <h3 className="text-xl font-bold">Machine Learning
                                                        Specialization</h3>
                                                    <p className="text-muted-foreground mb-2">Stanford University, Jul
                                                        2023</p>
                                                    <Link
                                ...
                                <FadeIn delay={0.4} direction="up">
                                    <HoverScale>
                                        <Card>
                                            <CardContent className="pt-6">
                                                <div className="flex flex-col">
                                                    <h3 className="text-xl font-bold">Duke University Specialization:
                                                        Data Analysis with R</h3>
                                                    <p className="text-muted-foreground mb-2">Duke University, Jun
                                                        2023</p>
                                                    <Link
                                ...
                                <FadeIn delay={0.5} direction="up">
                                    <HoverScale>
                                        <Card>
                                            <CardContent className="pt-6">
                                                <div className="flex flex-col">
                                                    <h3 className="text-xl font-bold">Data Analysis with R
                                                        Programming</h3>
                            ...
                            <p className="mt-4 text-sm text-muted-foreground">
                                See more on <Link href="https://www.linkedin.com/in/jaidityadev/details/certifications/"
                                                  target="_blank"
                                                  className="text-primary hover:underline">LinkedIn</Link>.
                            </p>
                        </section>
                                        ...
                                        <Card>
                                            ...
                                            <CardContent>
                                                <div className="flex flex-wrap gap-2">
                                                    ...
                                                    <Badge variant="secondary">Spring Data MongoDB</Badge>
                                                    <Badge variant="secondary">Springdoc OpenAPI</Badge>
                                        ...
                                        <Card>
                                            ...
                                            <CardContent>
                                                <div className="flex flex-wrap gap-2">
                                                    ...
                                                    <Badge variant="secondary">OpenAI Java SDK</Badge>
                                                    <Badge variant="secondary">Axios</Badge>
                                                    <Badge variant="secondary">MongoDB</Badge>
                                                    <Badge variant="secondary">JWT (RS256)</Badge>
                        ...
                        <section className="mb-12">
                                ...
                                <HoverScale scale={1.01}>
                                    <Card>
                                        <CardContent className="pt-6">
                                            ...
                                            <ul className="list-disc list-inside text-muted-foreground space-y-3">
                                                <li>
                                                    Facilitated weekly tutorials for <span
                                                    className="font-medium text-foreground">STA107H5S: Introduction to Probability and Modelling</span>,
                                                    engaging students in activities on discrete distributions, sampling,
                                                    and statistical inference.
                                                </li>
                                                <li>
                                                    Provided guidance on <span className="font-medium text-foreground">R programming</span>,
                                                    supporting students in simulating probabilities and applying
                                                    statistical concepts.
                                                </li>
                                                <li>
                                                    Assessed student submissions and provided feedback on assignments,
                                                    ensuring alignment with course learning outcomes.
                                                </li>
                                            </ul>
                                        </CardContent>
                                    </Card>
                                ...
                                <HoverScale scale={1.01}>
                                    <Card>
                                        <CardContent className="pt-6">
                                            ...
                                            <ul className="list-disc list-inside text-muted-foreground space-y-3">
                                                <li>
                                                    Developed a <span className="font-medium text-foreground">machine learning classification model</span> to
                                                    identify tax form types, managing a <span
                                                    className="font-medium text-foreground">real-time dataset of 800,000+ entries</span>.
                                                </li>
                                                <li>
                                                    Refined <span className="font-medium text-foreground">keyword search algorithms</span> and
                                                    deployed <span className="font-medium text-foreground">data visualization</span> tools,
                                                    such as <span
                                                    className="font-medium text-foreground">word clouds</span>, for
                                                    enhanced data analysis and stakeholder engagement.
                                                </li>
                                                <li>
                                                    Collaborated with cross-functional teams to integrate <span
                                                    className="font-medium text-foreground">data-driven solutions</span>,
                                                    boosting strategic decision-making and <span
                                                    className="font-medium text-foreground">operational efficiency</span>.
                                                </li>
                                            </ul>
                                        </CardContent>
                                    </Card>
                                    ...
                                    <Card>
                                        <CardContent className="pt-6">
                                            <div
                                                ...
                                                <div className="text-muted-foreground"><span>May 2023 – Aug 2023</span>
                                                </div>
                                            </div>
                                            <div
                                                className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
                                                <p className="font-medium">University of Toronto, Mississauga</p>
                                                <div className="text-muted-foreground"><span>Mississauga, ON</span>
                                                </div>
                                            </div>
                                            <ul className="list-disc list-inside text-muted-foreground space-y-2">
                                                <li>Conducted research on causal inference models with Prof. Sonya
                                                    Allin.
                                                </li>
                                                <li>Authored literature reviews and presented findings at lab
                                                    meetings.
                                                </li>
                                            </ul>
                                        </CardContent>
                                ...
                                <HoverScale scale={1.01}>
                                    <Card>
                                        <CardContent className="pt-6">
                                            <div
                                                className="flex flex-col md:flex-row md:items-center md:justify-between mb-2">
                                                <h3 className="text-xl font-bold">LearnAI Program Teaching
                                                    Assistant</h3>
                                                <div className="text-muted-foreground"><span>Oct 2022 – Apr 2023</span>
                                                </div>
                                            </div>
                                            <div
                                                className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
                                            ...
                                            <ul className="list-disc list-inside text-muted-foreground space-y-2">
                                                <li>
                                                    Delivered tutorials on <span
                                                    className="font-medium text-foreground">ML</span>,{" "}
                                                    <span className="font-medium text-foreground">neural networks</span>,
                                                    and{" "}
                                                ...
                                                <li>
                                                    ...
                                                    fostering <span
                                                    className="font-medium text-foreground">curiosity</span> and{" "}
                                                    <span className="font-medium text-foreground">skills</span>.
                                                </li>
                                                <li>
                                                    Assessed assignments and provided{" "}
                                                    <span
                                                        className="font-medium text-foreground">constructive feedback</span>.
                                                </li>
                                            </ul>
                                        </CardContent>
                                    </Card>
                                    ...
                                    <Card>
                                        <CardContent className="pt-6">
                                            <div
                                                ...
                                                <div className="text-muted-foreground"><span>May 2022 – Apr 2024</span>
                                                </div>
                                            </div>
                                            <div
                                                className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
                                            ...
                                            <ul className="list-disc list-inside text-muted-foreground space-y-2">
                                                ...
                                                <li>
                                                    ...
                                                    <span
                                                        className="font-medium text-foreground">improve campus dining</span>.
                                                </li>
                                            </ul>
                                        </CardContent>
                                    </Card>
                                ...
                                <HoverScale scale={1.01}>
                                    <Card>
                                        <CardContent className="pt-6">
                                            ...
                                            <ul className="list-disc list-inside text-muted-foreground space-y-3">
                                                <li>
                                                    Collaborated within the EY Strategy Analysis Team to study the
                                                    evolving <span className="font-medium text-foreground">Asia Pacific 3D Printing market</span>.
                                                </li>
                                                <li>
                                                    Utilized <span className="font-medium text-foreground">statistical modeling and market assessments</span> to
                                                    evaluate the market's feasibility for the <span
                                                    className="font-medium text-foreground">I.I.T. Delhi Incubation Center</span>.
                                                </li>
                                                <li>
                                                    Developed <span className="font-medium text-foreground">data-driven models</span> for
                                                    optimizing <span className="font-medium text-foreground">3D Printing filament procurement</span> strategies
                                                    through <span className="font-medium text-foreground">regression analysis</span> and <span
                                                    className="font-medium text-foreground">trend forecasting</span>.
                                                </li>
                                            </ul>
                                        </CardContent>
                                    </Card>
                                ...
                                <HoverScale scale={1.01}>
                                    <Card>
                                        <CardContent className="pt-6">
                                            ...
                                            <ul className="list-disc list-inside text-muted-foreground space-y-3">
                                                <li>
                                                    Led research on the <span className="font-medium text-foreground">prediction of Dengue and Tuberculosis</span> using <span
                                                    className="font-medium text-foreground">ensemble-based forecasting techniques</span>,
                                                    contributing to proactive public health measures.
                                                </li>
                                                <li>
                                                    Co-authored and presented research papers at international
                                                    conferences, including the <span
                                                    className="font-medium text-foreground">International Conference on AI</span> and
                                                    the <span className="font-medium text-foreground">Swiss OpenTox Conference</span>.
                                                </li>
                                            </ul>
                                        </CardContent>
                                    </Card>
                                    ...
                                    <Card>
                                        <CardContent className="pt-6">
                                            <div
                                                ...
                                                <div className="text-muted-foreground"><span>Jun 2019 – Jun 2019</span>
                                                </div>
                                            </div>
                                            <div
                                                className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
                          ...
                          <span className="font-medium text-foreground">
                            Analyzed the Indian electric mobility value chain
                                                ...
                                                <li>
                                                    <span className="font-medium text-foreground">Collaborated cross‑functionally</span> to
                                                    develop
                                                    <span className="font-medium text-foreground">
                                        ...
                                        <CardContent className="pt-6">
                                            <div
                                                ...
                                                <h3 className="text-xl font-bold">
                                                    Health TrueInfo: A multilingual Android app and social media
                                                    approach in tackling COVID-19 vaccine misinformation and hesitancy
                                                    in Bolivia, India, and Canada
                                                </h3>
                                                <div className="text-muted-foreground">
                                            ...
                                            <p className="text-foreground mb-4">
                                                Developed and evaluated a multilingual Android app alongside targeted
                                                social media campaigns, achieving measurable reductions in vaccine
                                                hesitancy across three countries.
                                            </p>
                                            <ul className="list-disc list-inside text-muted-foreground space-y-3">
                                                <li>
                                                    <Link
                        ...
                        <span>
                          In Handbook of Research on Machine Learning Foundations and Applications (Book Chapter)
                                            ...
                                            {/* description */}
                                            <p className="text-foreground mb-4">
                                                Provides a comprehensive overview of time‑series forecasting methods,
                                                challenges, and enabling technologies for large‑scale IoT deployments.
                                            </p>
                                ...
                                <HoverScale scale={1.01}>
                                    <Card>
                                        <CardContent className="pt-6">
                                            ...
                                            <p className="text-foreground mb-4">
                                                Combined multiple forecasting algorithms into one ensemble to
                                                significantly improve the accuracy of outbreak predictions for diseases
                                                like dengue and tuberculosis.
                                            </p>
                                            <ul className="list-disc list-inside text-muted-foreground space-y-3">
                                                <li>
                                                    <a
                                ...
                                <HoverScale scale={1.01}>
                                    <Card>
                                        <CardContent className="pt-6">
                                            ...
                                            <p className="text-foreground mb-4">
                                                Explored ARIMA-based techniques to optimize parameter selection and
                                                improve forecasting precision across diverse datasets.
                                            </p>
                                            <ul className="list-disc list-inside text-muted-foreground space-y-3">
                                                <li>
                                                    <a
