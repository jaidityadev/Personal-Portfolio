          ...
          <div className="max-w-4xl mx-auto">
            <FadeIn>
              ...
              <p className="text-xl text-muted-foreground mb-12">
                Open to technology consulting, data science, and AI engineering roles. Email is fastest.
              </p>
            </FadeIn>
            ...
            <FadeIn delay={0.7} className="mt-16 text-center">
              ...
              <p className="text-muted-foreground mb-8 max-w-2xl mx-auto">
                Hiring, building, or researching? Reach out and I&apos;ll get back to you quickly.
              </p>
