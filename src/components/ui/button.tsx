...
/*
 * The press state is a CSS :active rule on purpose — it lands on pointer-down
 * with no JS on the input path, which is the only way the press reads as
 * instant. Colour and shadow ease over 150ms; the scale snaps in 100ms.
 */
  ...
  ].join(" "),
  {
    variants: {
      variant: {
        ...
        outline:
          "material-chrome border border-border text-foreground shadow-e1 hover:border-primary/40 hover:text-primary hover:shadow-e2",
        secondary:
